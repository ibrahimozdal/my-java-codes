...
public class Ternary01 {
	...
	//	 If an integer is positive print "The integer is positive" otherwise print "The integer is not positive"
		...
		String result = num > 0 ? "The integer is positive" : "The integer is not positive";   /// COK ONEMLI FORMUL
 ...
 // ternary is shorter system , it doesnt use many conditions. ternary is faster than if else.
//alttaki ifadelerin ustte olani if statement tan geldi. altta olan ise ternary formulunden geldi.
